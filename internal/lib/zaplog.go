...
func ZapCoreInit() {
	MainLogger = NewLogger("./logs/main.log", zapcore.InfoLevel, 128, 3, 7, true, "Main")
	RecordLogger = NewLogger("./logs/record.log", zapcore.InfoLevel, 128, 3, 7, true, "Record")
	MainLogger.Info("campus server started")
}
